...
public class WeatherClient {
	...
	@Autowired
	public WeatherClient(final RestTemplate restTemplate, @Value("${weather.url}") final String weatherServiceUrl,
	...
	public Optional<WeatherResponse> fetchWeatherWithAPI(String latitude, String longitude) {
		String url = String.format("%s/%s/%s,%s", weatherServiceUrl, weatherServiceApiKey, latitude, longitude);
